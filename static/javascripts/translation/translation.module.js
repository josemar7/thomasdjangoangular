(function () {
  'use strict';
    ...
    var translationsEn = {
      ...
      ACCEPT: 'Accept',
      ACCOUNT_CAN_NOT_DELETE: 'Your account can\'t be deleted because the password is incorrect',
    ...
    var translationsEs = {
      ...
      ACCEPT: 'Aceptar',
      ACCOUNT_CAN_NOT_DELETE: 'Tu cuenta no se puede borrar porque la contraseña es incorrecta',
      ACCOUNT_DELETED: 'Tu cuenta ha sido borrada',
      COMMENT: 'Comentario',
